...
- `btc_donchian_breakout_vol_filter`
...
- 초기에는 구조만 준비하고, 실제 자동 연구 대상은 좁은 종목군과 전략군에서 시작한다.
...
- 파라미터 공간이 커질수록 과최적화 위험이 커지므로, 초기에는 좁고 해석 가능한 범위를 우선한다.
