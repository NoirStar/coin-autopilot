 ...
 *
 * 청산:
 *   손절: ATR(14) x 1.5 (calcATRStop 유틸리티 사용)
 *   트레일링 스탑: ATR(14) x 2.5 (peak 기반)
 *   시간 청산: 24캔들
 *   반대 크로스: MACD 히스토그램 방향 전환 시
 */
class BtcMacdMomentumV2 implements Strategy {
...
// 레지스트리에 자동 등록
registerStrategy(new BtcMacdMomentumV2())

export { BtcMacdMomentumV2 }
