...
/**
 * BTC/ETH 볼린저 밴드 평균회귀 전략 (OKX 선물용) — V2
 *
 ...
 *
 * 청산:
 *   1차: BB 중심선 도달 시 전량 익절
 *   손절: ATR(14) x 1.0 (calcATRStop 유틸리티 사용)
 *   시간: 20캔들 (≈3일)
 */
class BtcBollingerReversionV2 implements Strategy {
...
// 레지스트리에 자동 등록
registerStrategy(new BtcBollingerReversionV2())

export { BtcBollingerReversionV2 }
